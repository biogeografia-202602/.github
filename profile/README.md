...
<https://github.com/biogeografia-202602>
...
- [Introducción a R](https://geofis.shinyapps.io/tutorial1/). Creé este
  tutorial hace años, cuando ni soñábamos con LLM basados en IA
  generativa. Sin embargo, después de 2022, el tutorial no es más que un
  complemento útil. Sin embargo, si logras completarlo, te ayudará mucho
  a introducirte a la programación orientada a objetos, y te servirá
  para comprender lo básico del código R que usarás en las prácticas.
  Para Python hice algo similar, pero cualquier IA te enseñará mejor que
  yo a escribir/usar código.
